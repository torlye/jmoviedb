...
public class MediaLabelProvider extends LabelProvider implements ITableLabelProvider {
    @Override
    ...
    public static String getColumnTextForIndex(Object element, int columnIndex) {
        Tuple<String, Integer> obj = (Tuple<String, Integer>)element;
        switch (columnIndex) {
            case 0:
                return obj.getValue1();
            case 1:
                return obj.getValue2().toString();
        }
        return "";
    }
}
