...
public class ExportCsvReleasesAction extends Action {
	public ExportCsvReleasesAction() {
		setText("Export CSV of Releases");
	}
	...
	public void run() {
		...
		if(filePath != null) {
			try {
				...
				CSVexportReleases exportWorker = new CSVexportReleases(filePath);
