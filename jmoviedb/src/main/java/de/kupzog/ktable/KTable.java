...
*/
    public int getVisibleRowCount(int fixedHeight) //KTable Sourceforge patch 1711263
    {
    	Rectangle rect = getClientArea();
    	ScrollBar sb = getHorizontalBar();
    	if (sb != null)
    ...
    private int getFullyVisibleRowCount(int fixedHeight) { //KTable Sourceforge patch 1711263
    	Rectangle rect = getClientArea();
    	ScrollBar sb = getHorizontalBar();
    	if (sb != null)
    		rect.height-=sb.getSize().y;
    ...
    protected void doCalculations() { //KTable Sourceforge patch 1711263
    	...
    	if (m_Model.getColumnCount() > getFixedColumnCount()) {
    		int runningWidth = getColumnLeft(m_LeftColumn);
    		for (int col = m_LeftColumn; col < m_Model.getColumnCount();
    		col++) {
    			if (runningWidth < rect.width + rect.x)
    				m_ColumnsVisible++;
    			runningWidth += getColumnWidth(col);
